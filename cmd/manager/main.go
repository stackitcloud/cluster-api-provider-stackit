...
import (
	...
	"github.com/stackitcloud/cluster-api-provider-stackit/controller"
	webhookv1alpha1 "github.com/stackitcloud/cluster-api-provider-stackit/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "85750c9c.cluster.x-k8s.io",
